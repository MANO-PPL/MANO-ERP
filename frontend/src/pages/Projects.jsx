            ...
            try {
                ...
                if (projRes && projRes.success && projRes.project) {
                    ...
                    setLiveDetails({
                        ...
                        employer: stripEmojis(p.employer || meta.employer || project.employer || 'System'),
                        client: stripEmojis(p.employer || meta.client || project.client || ''),
                        owner: stripEmojis(p.employer || meta.employer || meta.client || project.owner || 'System'),
            ...
            if (res.success) {
                const mappedProjects = res.projects.map(p => {
                    ...
                    return {
                        ...
                        owner: p.employer || meta.employer || 'System',
                        employer: p.employer || meta.employer || 'System',
