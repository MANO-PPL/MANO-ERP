...
const GDCard = ({ name, icon: Icon, onClick }) => (
    <div
        onClick={onClick}
...
const QualityIndex = ({ setExtraBreadcrumbs }) => {
    ...
    const docs = [
        ...
        { id: 'qaqc', name: 'QA/QC', icon: FlaskConical },
        { id: 'lab', name: 'Quality Control Lab Setup', icon: FlaskConical },
        { id: 'checklist', name: 'Checklist & Snaglist', icon: CheckSquare },
    ];
