                ...
                <div className="flex items-center justify-end gap-2.5 pb-1">
                    <div className="relative w-64 md:w-80">
                        ...
                        <input
                            ...
                            placeholder="Search methodology document name, format..."
                    ...
                    <div className="flex flex-col items-center justify-center py-16 bg-white dark:bg-[#161b22] border border-gray-200 dark:border-white/10 rounded-md text-center p-6 space-y-3">
                        ...
                        <div>
                            <h3 className="text-sm font-bold text-gray-900 dark:text-white">
                                {searchQuery ? 'No matching methodology files found' : 'No methodology files uploaded yet'}
                            </h3>
                            <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                                {searchQuery ? 'Try clearing your search query.' : 'Upload quality execution guidelines, standard practices, or protocols for this project.'}
                            </p>
                        </div>
                        ...
                        <form onSubmit={handleUpload} className="flex-1 overflow-y-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden no-scrollbar p-4 space-y-4 text-left">
                            ...
                            <div className="space-y-1.5">
                                ...
                                {selectedFile ? (
                                    ...
                                    >
                                        <div className="w-10 h-10 rounded-md bg-blue-50 dark:bg-blue-950/40 text-blue-500 flex items-center justify-center group-hover:scale-105 transition-transform">
                                            <Upload size={20} />
                                        </div>
...
export default QualityMethodology;
