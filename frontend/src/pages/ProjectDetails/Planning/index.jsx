                                ...
                                <div className="relative flex items-center w-full">
                                    ...
                                    <div className="ml-8 flex-1 text-left">
                                        <div className="flex items-center space-x-3 mb-1.5">
                                            <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 tracking-tight leading-tight group-hover:text-blue-500 transition-colors uppercase font-black">
                                                {cat.name}
                                            </h3>
                                        </div>
