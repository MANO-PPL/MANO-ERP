        ...
        <div className="relative flex items-center w-full">
            ...
            <div className="ml-8 flex-1 text-left">
                ...
                <div className="flex items-center space-x-3">
                    <span className="text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-[0.2em] group-hover:text-gray-300 transition-colors">
                        {subtitle}
                    </span>
...
const ContractsIndex = ({ setExtraBreadcrumbs }) => {
    ...
    const docs = [
        { name: 'Quantity Survey', icon: FileSpreadsheet },
        { name: 'Quotation', icon: FileText },
        { name: 'Tender', icon: FileCheck },
        { name: 'Work Order & Purchase Order', icon: Briefcase },
    ];
