...
import { FileSpreadsheet, FileText, FileCheck, Briefcase, ChevronRight } from 'lucide-react';
...
const ContractsIndex = ({ setExtraBreadcrumbs }) => {
    ...
    const docs = [
        { 
            ...
            desc: 'Detailed measurement and quantification of all project works and materials.',
            icon: FileSpreadsheet, 
            type: 'Single Instance' 
        },
        { 
            name: 'Quotation', 
            desc: 'Price estimates and formal quotation documents from vendors and contractors.',
            icon: FileText, 
            type: 'Episodic' 
        },
        { 
            name: 'Tender', 
            desc: 'Official tender documents, bid submissions, and evaluation records.',
            icon: FileCheck, 
            type: 'Episodic' 
        },
        { 
            name: 'Work Order & Purchase Order', 
            desc: 'Issued work orders and purchase orders for project procurement.',
            icon: Briefcase, 
            type: 'Episodic' 
        },
    ];
