...
import { FileText, Receipt, FileSpreadsheet, ChevronRight } from 'lucide-react';
...
const BillingIndex = ({ setExtraBreadcrumbs }) => {
    ...
    const docs = [
        { name: 'Invoice – Materials', icon: FileText },
        { name: 'Invoice – Contractors', icon: FileText },
        { name: 'Certified Bills Copy', icon: Receipt },
        { name: 'List of Certified Bills (Monthly)', icon: FileSpreadsheet },
    ];
