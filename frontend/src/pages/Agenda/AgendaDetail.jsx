...
const AgendaDetail = () => {
    ...
    const [points, setPoints] = useState([
        { id: 1, slNo: '1', description: 'main point 1', remarks: 'remark' },
        { id: 2, slNo: '1.1', description: 'sub pointttttt', remarks: 'mark' },
        { id: 3, slNo: '2', description: 'main point 2', remarks: 'rem' },
    ]);
    ...
    const handleSave = () => {
        // Save logic here
        navigate(projectId ? `/projects/${projectId}/agenda` : '/dashboard/agenda');
    };
    ...
    const addPoint = () => {
        ...
        setPoints([...points, { id: Date.now(), slNo: newSlNo, description: '', remarks: '' }]);
    };
    ...
    return (
        <div className="flex-1 flex flex-col h-[calc(100vh-8vh)] bg-[#fafafa] dark:bg-[#0d1117] font-sans text-gray-900 dark:text-gray-700 dark:text-gray-300 transition-colors">
                ...
                <div className="flex items-center space-x-2 text-xs">
                    {projectId ? (
                        <>
                            ...
                            <ChevronRight size={14} className="text-gray-600 dark:text-gray-400 dark:text-gray-500" />
                            <span
                                onClick={() => navigate(`/projects/${projectId}/agenda`)}
                                className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 transition-colors font-medium cursor-pointer"
                            >
                                Agenda of Meeting
                            </span>
                            ...
                            <span className="text-gray-900 dark:text-gray-200 font-semibold cursor-default">
                                {id === 'new' ? 'New Agenda' : details.subject || 'Edit Agenda'}
                            </span>
                        </>
                    ) : (
                        <>
            ...
            <div className="flex justify-between items-center px-6 py-4 border-b border-gray-200 dark:border-white/10 bg-white dark:bg-[#0d1117] sticky top-0 z-10 w-full">
                <button
                    onClick={() => navigate(projectId ? `/projects/${projectId}/agenda` : '/dashboard/agenda')}
                    ...
                    <div className="bg-gray-50 dark:bg-[#161b22] border border-gray-200 dark:border-white/10 rounded-lg overflow-hidden flex flex-col shadow-sm">
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-left text-sm table-fixed">
                                <thead>
                                    <tr className="border-b border-gray-200 dark:border-white/10 text-gray-500 bg-gray-100 dark:bg-[#12161c]">
                                        <th className="px-2 py-3 w-16 text-xs font-medium text-center">Sl No.</th>
                                        <th className="px-5 py-3 text-xs font-medium">Description</th>
                                        <th className="px-5 py-3 w-1/3 text-xs font-medium hidden md:table-cell">Remarks</th>
                                        <th className="px-2 py-3 w-20 text-xs font-medium text-center">Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <AnimatePresence>
                                            {points.map((pt) => (
                                                ...
                                                >
                                                    ...
                                                    <td className="px-5 py-4 align-top w-full">
                                                        <div className="w-full group-hover/row:bg-white dark:bg-[#1c222b]/50 rounded-lg p-3 -m-3 transition-colors border border-transparent focus-within:border-blue-500/30 focus-within:bg-white dark:bg-[#1c222b] h-full flex flex-col">
                                                            <ResizableTextarea
                                                                value={pt.description}
                                                                onChange={(e) => updatePoint(pt.id, 'description', e.target.value)}
                                                                className="text-gray-800 dark:text-gray-200 w-full min-h-[44px] flex-1"
                                                    ...
                                                    <td className="px-5 py-4 hidden md:table-cell align-top">
                                                        <div className="w-full group-hover/row:bg-white dark:bg-[#1c222b]/50 rounded-lg p-3 -m-3 transition-colors border border-transparent focus-within:border-blue-500/30 focus-within:bg-white dark:bg-[#1c222b] h-full flex flex-col">
                                                            <ResizableTextarea
                                                                ...
                                                                className="text-gray-600 dark:text-gray-400 w-full min-h-[44px] flex-1"
