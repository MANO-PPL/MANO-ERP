                ...
                <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
                    ...
                    >
                        ...
                        <button
                            onClick={onClose}
                            disabled={isLoading}
                            className="absolute top-4 right-4 text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 transition p-1.5 rounded-xl hover:bg-gray-100 dark:hover:bg-white/5 cursor-pointer"
                        >
                            <X size={18} />
                        </button>
                        ...
                        <div className="mt-6 flex items-center justify-end gap-2.5">
                            <button
                                ...
                                onClick={onClose}
                                disabled={isLoading}
                                className="px-4 py-2 text-xs font-semibold text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl transition cursor-pointer"
                            >
                                {cancelText}
                            </button>
                            <button
                                ...
                                disabled={isLoading}
                                className={`px-4 py-2 text-xs font-bold rounded-xl transition flex items-center gap-2 ${config.btnBg} disabled:opacity-50 cursor-pointer`}
                            >
                                {isLoading ? (
                                    <>
